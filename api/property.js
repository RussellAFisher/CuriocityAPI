...
module.exports = {
  ...
  homeInfoByAddress: function(street, city, state) {
    return new Promise((resolve, reject) => {
  ...
  homeInfoByZipCode: function(street, zipcode) {
    return new Promise((resolve, reject) => {
      var url = 'http://www.zillow.com/webservice/GetDeepSearchResults.htm?zws-id=X1-ZWz19l7src3rbf_64j9s&address=' + street + '&citystatezip=' + zipcode;
